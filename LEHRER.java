...
public enum LEHRER
{
    ...
    SCHMELMER       (4, "Anton Schmelmer",         2f, 0.0001f, 0.0001f, TexturManager.DATEIPFAD + "StructureCar.png", TexturManager.DATEIPFAD + "StructureIcon.png",           TexturManager.DATEIPFAD + "Schmelmer.png"),
    ...
    TREMMEL         (9, "Andreas Tremmel",         2f, 0.0001f, 0.0001f, TexturManager.DATEIPFAD + "StructureCar.png", TexturManager.DATEIPFAD + "StructureIcon.png",           TexturManager.DATEIPFAD + "Tremmel.png"),
