...
public class Ende extends Bildschirm
{
    ...
    public Ende()
    {
        ...
        newArray();
        Text Überschrift = new Text(100,200,50,Line[0]);
        wurzel.add(Überschrift);
        Text t1 = new Text(100,300,20,Line[1]);
        wurzel.add(t1);
        Text t2 = new Text(100,340,20,Line[2]);
        wurzel.add(t2);
        Text t3 = new Text(100,380,20,Line[3]);
        wurzel.add(t3);
        Text t4 = new Text(100,420,20,Line[4]);
        wurzel.add(t4);
        Text t5 = new Text(100,460,20,Line[5]);
        wurzel.add(t5);
        Text score = new Text(600,120,50,Line[6]);
        wurzel.add(score);
        Text info = new Text(100, 500, 20, Line[7]);
        wurzel.add(info);
